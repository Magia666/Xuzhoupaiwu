import { Search, MapPin, Filter, Download, Eye, Edit, Trash2 } from "lucide-react";
                ...
                <tr key={row.id} className="hover:bg-blue-50/30 transition-colors">
                  ...
                  <td className="px-6 py-4 text-right">
                    <div className="flex items-center justify-end gap-2">
                      ...
                      <button className="p-1.5 text-gray-400 hover:text-red-500 hover:bg-red-50 rounded transition-colors" title="删除"><Trash2 className="w-4 h-4" /></button>
                    </div>
                  </td>
                </tr>
              ))}
